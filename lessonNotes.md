...
14) Modify the artist model (app>models>artist):
...
This will fix the reationship within the Database, (one to many relationship within the DB is now set up!) the artist now can have many songs!

15) We next want to test the relationships between the data in the DB

rails c (this opens the rails console)
